...
const AmazingService = () => {
  return (
    <div className="w-full px-3 md:px-16 xl:px-44 py-4 md:py-12 2xl:pt-24 z-50 bg-linear-to-r from-blue-50 via-blue-50 to-white items-center justify-center content-center text-center">
      {" "}
