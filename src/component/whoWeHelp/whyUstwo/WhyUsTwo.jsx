...
const WhyUsTwo = ({ data }) => {
  ...
  return (
    <div className="w-full px-4 md:px-16 xl:px-44 py-4 md:py-12 bg-linear-to-r from-blue-50 via-blue-50 to-white flex flex-col-reverse lg:flex-row justify-evenly">
