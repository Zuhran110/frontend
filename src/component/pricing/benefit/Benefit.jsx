...
const Benefit = () => {
  return (
    <div className="w-full px-16 xl:px-44 py-4 md:py-18 xl:pb-36 z-50 bg-linear-to-r from-blue-50 via-blue-50 to-white items-center justify-evenly flex flex-col lg:flex-row">
