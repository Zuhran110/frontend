...
const Benefit = () => {
  return (
    <div className="w-full px-16 xl:px-44 py-4 md:py-12 z-50 bg-linear-to-r from-blue-50 via-blue-50 to-white items-center justify-between flex flex-col lg:flex-row">
      <div className="w-full md:w-2/3 lg:w-1/2 text-center md:text-start">
